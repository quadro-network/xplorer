...
** if you want to list your blockhain on  Stake-Take, please submit your configure on https://github.com/ping-pub/ Stake-Take.git **

- Submit configs for mainnet, go to https://github.com/ping-pub/explorer/tree/master/chains/mainnet

- Submit configs for testnet, go to https://github.com/ping-pub/explorer/tree/master/chains/testnet, thess configs will be enabled when you visit the domain starts withs `testnet.*`, for example `https://testnet. Stake-Take`
...
```json
{
    ...
    "api": [
        {
            "address": "https://cosmos.api. Stake-Take", 
            "provider": "Ping"
        }
    ], 
    "rpc": [
...
```
- **chain_name** the name to identify the chain on  Stake-Take, would be better to use the same one as registry
