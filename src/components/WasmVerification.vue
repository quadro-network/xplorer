...
<template>
    <div class="#saved px-4 pt-3 pb-4 rounded mb-4 shadow">
        <div role="tablist" class="tabs tabs-boxed">
          <a role="tab" class="tab tooltip tooltip-right tooltip-base-content" data-tip="Powered By WELLDONE Studio">
            <div class="w-8 rounded">
              <img src="../assets/images/welldone-logo.svg"  alt="Powered By WELLDONE Studio"/>
            </div>
          </a>
          <a role="tab" class="tab" :class="{'tab-act': tab==='verification'}" @click="selectTab('verification')">Verification</a>
          <a role="tab" class="tab" :class="{'tab-act': tab==='executions'}" @click="selectTab('executions')">Functions</a> 
          <a role="tab" class="tab" :class="{'tab-act': tab==='source_code'}" @click="selectTab('source_code')">Source Code</a>
        </div>
        <div class="">
        ...
        <div v-show="tab === 'verification'" class="text-center">
            ...
            <button class="btn  #sav1 mt-5" @click="verify" v-show="tab === 'verification'" :disabled="verification.error !== undefined">verify</button>
        </div>
