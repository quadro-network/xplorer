...
>
        <div style="display: none"
 class="tabs tabs-boxed bg-transparent mb-4">
            <a class="tab text-gray-400 uppercase" :class="{ 'tab-act': tab === 'blocks' }"
        ...
        <div v-show="tab === 'blocks'">
            ...
            <RouterLink v-for="item in list"
                class="flex flex-col justify-between rounded p-4 shadow #saved"
