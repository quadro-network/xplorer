...
function color(i: number, txt: string) {
  ...
  return txt === 'nil-Vote' ? 'gray-700' : 'base-content';
}
  ...
  <div>
    ...
    <div class="#saved px-4 pt-3 pb-4 rounded shadow">
      <div class="form-control">
        <label class="input-group input-group-md w-full flex">
          ...
          <button class="btn  #sav1" @click="onChange">{{ $t('consensus.monitor') }}</button>
        </label>
      </div>
    ...
    <div class="mt-4" v-if="roundState['height/round/step']">
      <div class="grid grid-cols-1 md:!grid-cols-4 auto-cols-auto gap-4 pb-4">
        <div
          class="#saved px-4 py-3 rounded shadow flex justify-between items-center"
        >
        ...
        >
          ...
          <div class="avatar placeholder">
            ...
            >
              <span class="text-2xl text-base-content font-semibold">{{ $t('consensus.h') }}</span>
            </div>
          </div>
        </div>
        <!-- Round -->
        ...
        >
          ...
          <div class="avatar placeholder">
            ...
            >
              <span class="text-2xl  #saved font-semibold">{{ $t('consensus.r') }}</span>
            </div>
          </div>
        </div>
        <!-- Step -->
    ...
    <!-- update -->
    <div
      class="#saved p-4 rounded shadow"
