...
<template>
  <div>
    ...
    <div class="gap-4 mb-4 grid lg:!!grid-cols-3 auto-rows-max">
      ...
      <div class="#saved px-4 pt-3 pb-4 rounded shadow">
        ...
        <div class="mb-1" v-for="(item, index) of processList" :key="index">
          ...
          <div class="h-5 w-full relative">
            ...
            ></div>
            <p
              class="absolute inset-x-0 inset-y-0 text-center text-sm text-[#6e6e6d] dark:text-[#eee] flex items-center justify-center"
            >
              {{ item.value }}
            </p>
          </div>
        ...
        <div class="mt-6 grid grid-cols-2">
          <label
            for="vote"
            class="btn  #sav1 float-right btn-sm mx-1"
      ...
      <div class="#saved px-4 pt-3 pb-5 rounded shadow lg:!!col-span-2">
        ...
        <div class="px-1">
          ...
          <div class="flex items-center mb-4">
            <div class="w-2 h-2 rounded-full #sav1 mr-3"></div>
            <div class="text-base flex-1 text-main">
              {{ $t('gov.deposited_at') }}:
              {{
                format.toDay(
