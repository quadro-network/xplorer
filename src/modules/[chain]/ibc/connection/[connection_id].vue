...
<template>
  <div class="">
    <div class="px-4 pt-3 pb-4 bg-gray-950 rounded mb-4 shadow ">
      <div class="mx-auto max-w-7xl px-6 lg:!px-8">
        <dl class="grid grid-cols-1 gap-x-6 text-center lg:!grid-cols-3">
          ...
          <div class="mx-auto flex items-center">
            <div :class="{ 'text-base-content': conn.state?.indexOf('_OPEN') > -1 }">
    ...
    <div class="#saved px-4 pt-3 pb-4 rounded mb-4 shadow overflow-hidden">
