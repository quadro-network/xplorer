...
<template>
  <div>
    <div v-if="coinInfo && coinInfo.name" class="#saved rounded shadow">
        ...
        <div class="col-span-2 md:col-span-1">
          ...
          <div>
            <div class="dropdown dropdown-hover w-full">
              <label>
                <div
                  class="bg-gray-100 dark:bg-[#141414] flex items-center justify-between px-4 py-2 cursor-pointer rounded">
                  <div>
              ...
              <div class="dropdown-content pt-1">
                <div class="h-64 overflow-auto w-full shadow rounded">
                  <ul class="menu w-full bg-gray-100 rounded dark:bg-[#141414]">
            ...
            <div class="flex">
              <label class="btn  #sav1 !px-1 my-5 mr-2" for="calculator">
              ...
              <a class="my-5 !text-white btn grow" :class="{'!btn-base-content': store.trustColor === 'green', '!btn-warning': store.trustColor === 'yellow'}" :href="ticker.trade_url"
                target="_blank">
      ...
      <div class="h-[1px] w-full bg-gray-100 dark:bg-[#141414]"></div>
      ...
      <div class="mx-4 flex flex-wrap items-center">
        <div v-for="tag in coinInfo.categories"
          class="mr-2 mb-4 text-xs bg-gray-100 dark:bg-[#141414] px-3 rounded-full py-1">
          {{ tag }}
        </div>
      </div>
    </div>
    ...
    <div style="display: none" class="#saved rounded mt-4 shadow">
      ...
      <div class="grid grid-cols-1 md:!grid-cols-4 auto-cols-auto gap-4 px-4 pb-6">
        <div class="bg-gray-100 dark:bg-[#141414] rounded-sm px-4 py-3">
