...
<template>
  <div>
    <div class="#saved px-4 pt-3 pb-4 rounded shadow border-indigo-500">
    ...
    <div class="mt-3 grid grid-cols-1 md:!grid-cols-3 gap-4">
      ...
      <div class="#saved rounded shadow relative overflow-auto">
      ...
      <div class="#saved rounded shadow overflow-x-auto">
    ...
    <div v-if="delegations.delegation_responses" class="mt-5 #saved shadow rounded p-4 ">
    ...
    <div class="mt-5 #saved shadow rounded p-4">
        ...
        <table class="table validatore-table w-full">
          ...
          <tbody>
            <tr v-for="(item, i) in txs.tx_responses">
              ...
              <td class="truncate  #saved" style="max-width: 200px">
      ...
      <div class="text-lg mb-4 font-semibold">
        <div class="tabs tabs-boxed bg-transparent">
                ...
                <a
                    ...
                    :class="{ 'tab-act': selectedEventType === EventType.Delegate }"
                    @click="loadPowerEvents(1, EventType.Delegate)"
                    >{{ $t('account.btn_delegate') }}</a
                >
                <a
                    class="tab text-gray-400"
                    :class="{ 'tab-act': selectedEventType === EventType.Unbond }"
        ...
        <table class="table validatore-table w-full">
          ...
          <tbody>
            <tr v-for="(item, i) in events.tx_responses">
              <td class="pr-2 truncate  #saved" style="max-width: 250px">
              ...
              <td width="150">
                <RouterLink class=" #saved mb-0" :to="`/${props.chain}/block/${item.height}`">{{
                  item.height
                }}</RouterLink><br>
