  ...
  <div>
    <div class="#saved px-4 pt-3 pb-4 rounded mb-4 shadow">
      ...
      <div class="text-sm">
        ...
        <a class=" #saved lowercase" href="https://blog.cosmos.network/cosmos-sdk-state-sync-guide-99e4cf43be2f">{{
          $t('statesync.here') }}&nbsp;</a>
        <a class="lowercase">
    ...
    <div class="#saved px-4 pt-3 pb-4 rounded mb-4 shadow">
      ...
      <div class="text-sm">
        ...
        3. {{ $t('statesync.text_3') }}: <code
          class="bg-gray-950 text-gray-600 px-2 py-px mx-1 rounded shadow">{{ appName }} start</code>
        <br />
        {{ $t('statesync.text_3_1') }}
        <code class="bg-gray-950 text-gray-600 px-2 py-px mx-1 rounded shadow">{{ appName }} unsafe-reset-all</code> or
        <code
          class="bg-gray-950 text-gray-600 px-2 py-px mx-1 rounded shadow">{{ appName }} tendermint unsafe-reset-all --home ~/.HOME</code>
