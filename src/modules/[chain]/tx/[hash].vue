...
<template>
    <div>
        ...
        <div v-if="tx.tx_response" class="#saved px-4 pt-3 pb-4 rounded shadow mb-4">
                ...
                <table class="table text-sm">
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>
                                <RouterLink :to="`/${props.chain}/block/${tx.tx_response.height}`" class=" #saved dark:invert">{{ tx.tx_response.height
                                }}
                                </RouterLink>
                            </td>
                        </tr>
                        <tr>
                            ...
                            <td>
                                <span class="text-xs truncate relative py-2 px-4 w-fit mr-2 rounded" :class="`text-${tx.tx_response.code === 0 ? 'base-content' : 'error'
                                    }`">
                                    <span class="inset-x-0 inset-y-0 opacity-10 absolute" :class="`bg-${tx.tx_response.code === 0 ? 'base-content' : 'error'
                                        }`"></span>
                                    {{ tx.tx_response.code === 0 ? 'base-content' : 'Failed' }}
                                </span>
                                <span>
        ...
        <div v-if="tx.tx_response" class="#saved px-4 pt-3 pb-4 rounded shadow">
