...
<template>
  <div>
    <div class="overflow-x-auto w-full rounded-md">
      <div class="flex flex-wrap justify-between #saved p-5">
        <div class="min-w-0">
        ...
        <div class="flex flex-col text-right">
          ...
          <span class="text-xl text-base-content font-bold">${{ format.formatNumber(totalValue, '0,0.[00]') }}</span>
    ...
    <div class="overflow-x-auto">
      <div v-for="{ key, subaccounts } in accounts" class="#saved rounded-md my-5 py-5">
        <div class="flex justify-self-center">
          <div class="mx-2 p-2">
            <svg :fill="chainStore.current?.themeColor || '#141414'" height="28px" width="28px" version="1.1" id="Capa_1"
      ...
      <div class=" text-center #saved rounded-md my-4 p-4">
    ...
    <div class="modal" id="address-modal">
      <div class="modal-box">
        ...
        <div class="modal-action mt-2 mb-0">
          <a href="#" class="btn  #sav1 btn-sm" @click="importStep = 'step1'">Close</a>
        </div>
      </div>
    </div>
  </div>
