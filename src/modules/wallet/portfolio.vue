  ...
  <div class="overflow-x-auto w-full rounded-md">
    ...
    <div class="flex flex-wrap justify-between #saved p-5">
      ...
      <div class="text-right">
        <div>Total Value</div>
        <div class="text-base-content font-bold">{{ currencySign }} {{ format.formatNumber(totalValue, '0,0.[00]') }}</div>
        <div class="text-xs" :class="{ 'text-base-content': totalChangeIn24 > 0, 'text-error': totalChangeIn24 < 0 }">
